...
- profile.md (identity, succession, portfolio, custody setup, estate_documents, trust_details)
...
In profile.md: set `key_package: yes`, `key_package_created: <today>`, `last_verified: <today>`, `key_package_verified_date: <today>` under Estate/succession.
