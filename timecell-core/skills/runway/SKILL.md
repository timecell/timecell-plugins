...
Apply the **Runway** formulas from `references/computation-formulas.md` exactly.

Key inputs needed:
- Liquid asset total (from entity classification in Step 1)
- Monthly burn (expenses - income, from profile.md in Step 2)

Apply zone thresholds from the **Guardrail Zones > Runway** section of computation-formulas.md.
